...
protoc --go_out=./go --go-grpc_out=./go shifter.proto
...
protoc --js_out=import_style=commonjs,binary:./js/shifter-service shifter.proto
...
protoc --grpc-web_out=import_style=commonjs,mode=grpcwebtext:./web-js/shifter-service shifter.proto
